...
step, forward1 = escape((0, -1, 0), (width - 1, height))
step, backward = escape((width - 1, height, step + 1), (0, -1))
step, forward2 = escape((0, -1, step + 1), (width - 1, height))
print(forward1 + backward + forward2)
